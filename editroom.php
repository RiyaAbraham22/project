...
$sid=$_GET["uid"];
$edit=mysqli_query($con,"SELECT * FROM `tbl_room` WHERE `room_id` = '$sid'");
...
$qty=$_POST["qty"];
mysqli_query($con,"UPDATE `tbl_room` SET `price`='$price',`picture`='$upl',`roomqty`='$qty' WHERE `hid` ='$sid'");
                    ...
                    <div class="tableview">
                        <br>
                         ...
                         <form action="# " method="post" enctype="multipart/form-data">
                            ...
                            <tr>
                            <td>Room Quatity</td>
                            <td><input type="text" name="qty" value="<?php echo $row["roomqty"]; ?>"></td>
                            </tr>
                            <td>
                            </td>
                            <td><button class="btn1" name="ok" >Save</button></td>
                            </tr>
                            </table>
                        </form>
                        </center>
